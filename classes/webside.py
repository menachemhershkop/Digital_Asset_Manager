...
class Webside(DigitalAsset, Reportable):
    ...
    def to_report_line(self):
        return "type:",self.asset_type,"name:",self.name,"date:",self.time,"cost:",self.cost,"traffic:", self._monthly_traffic,"monetization: ",self._monetization_rate,"value: ", self.calculate_value()
